...
<div class="row">
    <div class="col-lg-6">
        <div class="input-group"><input id="_datetimepicker4" class="form-control" type="text"
                                        value="10.12.2013 23:45"/></div>
        <!-- /input-group --></div>
    <!-- /.col-lg-6 --></div>
<!-- /.row -->
<script type="text/javascript">// <![CDATA[
...
<p>By default, datetimepicker uses <a href="https://github.com/kartik-v/php-date-formatter">php-date-formatter</a> for
    parsing and formatting the date and time displayed. You can replace the library by setting a custom DateFormatter.
    Simply supply an object that implements the <tt>parseDate</tt> and <tt>formatDate</tt> methods. This example uses
    the popular <a href="http://momentjs.com/">MomentJS</a> library:</p>
...
<p>After this, you can init datetimepicker with moment.js <a href="http://momentjs.com/docs/#/parsing/string-format/"
                                                             target="_blanc" rel="nofollow">format</a></p>
...
<p><strong>Result</strong></p>
<p>Start <input id="date_timepicker_start" type="text" value=""/> End <input id="date_timepicker_end" type="text"
                                                                             value=""/></p>
<script type="text/javascript">// <![CDATA[
    jQuery(function () {
        jQuery('#date_timepicker_start').datetimepicker({
...
<table class="table table-condensed table-bordered table-striped">
    ...
    <tr id="lazyInit">
        ...
        <td>false</td>
        <td>Initializing plugin occurs only when the user interacts. Greatly accelerates plugin work with a large number
            of fields
        </td>
        <td></td>
    </tr>
...
<pre><code data-language="javascript">{value:'12.03.2013',
    ...
    <tr id="format">
        ...
        <td>Y/m/d H:i</td>
        <td>Format datetime. <a href="http://php.net/manual/ru/function.date.php" target="_blank">More</a> Also there is
            a special type of <a href="#unixtime"><em>«unixtime»</em></a></td>
        <td>
...
<pre><code data-language="javascript">{allowTimes:[
    ...
    <tr id="mask">
        ...
        <td>false</td>
        <td>Use mask for input. true - automatically generates a mask on the field 'format', Digit from 0 to 9, set the
            highest possible digit for the value. For example: the first digit of hours can not be greater than 2, and
            the first digit of the minutes can not be greater than 5
        </td>
        <td>
...
<pre><code data-language="javascript">onSelectDate:function(ct,$i){
    ...
    <tr id="ownerDocument">
        <td>ownerDocument</td>
        <td>document</td>
        <td>The ownerDocument object for the datetimepicker to properly attach events and calc position (iframe
            support).
        </td>
        <td></td>
    </tr>
